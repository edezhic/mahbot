Create a regular user and bind them to Telegram with a chosen default agent. Pass the user's display `name`, their Telegram `@username`, and the `default_agent` they start with — `assistant`.
